...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? '𝑏𝑤𝑎𝑏𝑦𝑚𝑜𝑢𝑑𝑦♨︎' : process.env.OWNER_NAME,
  ...
  antibadword :  process.env.ANTI_BAD_WORD === undefined ? 'fuck,chyeng' : process.env.ANTI_BAD_WORD,
